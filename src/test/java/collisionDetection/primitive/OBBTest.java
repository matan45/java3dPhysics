...
class OBBTest {
    ...
    public void testIntersects() {
        OBB obb1 = new OBB(
                ...
                new Vector3f[]{new Vector3f(1.0f, 0.0f, 0.0f), new Vector3f(0.0f, 1.0f, 0.0f), new Vector3f(0.0f, 0.0f, 1.0f)},
    ...
    public void testDoesNotIntersect() {
        ...
        OBB obb2 = new OBB(
                ...
                new Vector3f[]{new Vector3f(0.8f, -0.6f, 0.0f), new Vector3f(0.6f, 0.8f, 0.0f), new Vector3f(0.0f, 0.0f, 1.0f)},
                new Vector3f(1.5f, 0.8f, 0.3f)
        );
